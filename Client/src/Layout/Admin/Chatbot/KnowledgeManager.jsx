...
const KnowledgeManager = () => {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const res = await axios.get("http://localhost:8000/api/knowledge");
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`http://localhost:8000/api/knowledge/${id}`);
    ...
    const handleUpload = async () => {
        ...
        setUploading(true);
        try {
            await axios.post("http://localhost:8000/api/knowledge/upload", formData, {
